...
GPS_POSITION = (61.229486, 73.453289, 3)
IMAGE_SIZE = (1080, 608)
WORLD_SIZE = (25.0, 7.0)
...
class ParkingAnalyzer:
    def __init__(self, parking_spot_length=5.3, parking_spot_width=2.5, max_time_threshold=30,
                 output_csv="parking_data_test_photo.csv"):
    ...
    def _calculate_spot_density(self, spots):
        ...
        try:
            ...
            x = coords[:, 1] * kms_per_degree * np.cos(np.radians(lat_mean))
            y = coords[:, 0] * kms_per_degree
    ...
    def create_generalized_parking_map(self, output_file="generalized_parking_map_test_photo.html"):
    ...
    def _calculate_typical_corners(self, center, orientation, vehicle_type):
        ...
        for x, y in corners:
            ...
            rotated_corners.append([ry, rx])  # lat, lon
...
def sort_csv_by_timestamp(input_file="parking_data_test_photo.csv", output_file=None):
...
if __name__ == "__main__":
    ...
    csv_path = r"F:\PythonProjects\pythonProject8\output\test_photo\detection_results_test_photo.csv"
    ...
    m.save('parking_map_test_photo.html')
